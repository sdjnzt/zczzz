...
const originalTicketList = ref<TicketItem[]>([
  { id: 1, title: '老年人居家照护申请', type: '养老服务', handler: '宋倩', status: '处理中', progress: 2, createTime: '2025-06-01 09:00', logs: [ { time: '2025-06-01 08:00', content: '工单已派单', type: 'info' }, { time: '2025-06-01 09:00', content: '正在安排上门服务', type: 'warning' } ] },
  { id: 2, title: '社区环境整治', type: '环境问题', handler: '冯媛', status: '已完成', progress: 3, createTime: '2025-06-22 10:00', logs: [ { time: '2025-06-22 09:00', content: '工单已派单', type: 'info' }, { time: '2025-06-22 10:00', content: '环境整治完成', type: 'success' } ] },
  { id: 3, title: '社区文化活动策划', type: '文化活动', handler: '魏东', status: '待处理', progress: 1, createTime: '2025-06-21 14:00', logs: [ { time: '2025-06-21 14:00', content: '工单已派单', type: 'info' } ] },
  { id: 4, title: '志愿者招募活动', type: '志愿服务', handler: '张丽', status: '处理中', progress: 2, createTime: '2025-06-22 11:00', logs: [ { time: '2025-06-22 10:00', content: '工单已派单', type: 'info' }, { time: '2025-06-22 11:00', content: '正在组织招募', type: 'warning' } ] },
  { id: 5, title: '社区健康讲座', type: '医疗健康', handler: '李华', status: '已完成', progress: 3, createTime: '2025-06-18 09:00', logs: [ { time: '2025-06-18 08:00', content: '工单已派单', type: 'info' }, { time: '2025-06-18 09:00', content: '讲座已完成', type: 'success' } ] },
  { id: 6, title: '居民证件办理', type: '居民服务', handler: '孙丽', status: '待处理', progress: 1, createTime: '2025-06-18 13:00', logs: [ { time: '2025-06-18 13:00', content: '工单已派单', type: 'info' } ] },
  { id: 7, title: '社区设施维修', type: '设施维护', handler: '刘强', status: '处理中', progress: 2, createTime: '2025-06-19 10:00', logs: [ { time: '2025-06-19 09:00', content: '工单已派单', type: 'info' }, { time: '2025-06-19 10:00', content: '正在维修', type: 'warning' } ] },
  { id: 8, title: '社区安全巡查', type: '社区巡查', handler: '赵明', status: '已完成', progress: 3, createTime: '2025-06-19 15:00', logs: [ { time: '2025-06-19 14:00', content: '工单已派单', type: 'info' }, { time: '2025-06-19 15:00', content: '巡查完成', type: 'success' } ] },
  { id: 9, title: '社区安全隐患', type: '安全事件', handler: '马俊', status: '待处理', progress: 1, createTime: '2025-06-19 16:00', logs: [ { time: '2025-06-19 16:00', content: '工单已派单', type: 'info' } ] },
  { id: 10, title: '居民投诉处理', type: '居民服务', handler: '李伟', status: '处理中', progress: 2, createTime: '2025-06-18 17:00', logs: [ { time: '2025-06-18 16:00', content: '工单已派单', type: 'info' }, { time: '2025-06-18 17:00', content: '正在处理', type: 'warning' } ] }
])
