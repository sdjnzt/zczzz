...
const originalAssetList = ref<AssetItem[]>([
  { id: 1, assetNo: 'ZC2025001', name: '核心交换机-01', type: '网络设备', purchaseDate: '2025-06-10', warranty: '2026-01-10', vendor: '华为', price: '¥35000', status: '在用' },
  { id: 2, assetNo: 'ZC2025002', name: '应用服务器-01', type: '服务器', purchaseDate: '2025-06-15', warranty: '2026-02-15', vendor: '浪潮', price: '¥42000', status: '在用' },
  { id: 3, assetNo: 'ZC2025003', name: '存储阵列-01', type: '存储设备', purchaseDate: '2025-06-20', warranty: '2026-03-20', vendor: '华为', price: '¥60000', status: '闲置' },
